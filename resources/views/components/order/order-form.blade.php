    ...
    <div class="space-y-12 w-full max-w-2xl mx-auto">
        <div class="border-b border-gray-900/10 pb-12">
            ...
            <div class="border-b border-gray-900/10 py-12">
                ...
                <p class="mt-1 text-sm leading-6 text-gray-600">This information will be used to contact you about your
                    service.</p>

                <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                    <div class="mt-2">
                        <input type="text" name="street-address" id="street-address" placeholder="First name*"
                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>
                    ...
                    <div class="mt-2">
                        <input type="text" name="street-address" id="street-address" placeholder="Phone number*"
                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>
                </div>
            ...
            <div class="">
                ...
                <div class="sm:col-span-2 sm:col-start-1">
                    <div class="mt-2">
                        <input type="text" name="suite" placeholder="App/Suite #" autocomplete="address-level2"
                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>
                </div>
